...
# read CSV North_Data_Finalized_1<-read.csv(file='North_Data_Finalized_1.csv',check.names = F,stringsAsFactors = F)

read.table.url(url(description = "https://github.com/ALIYA2Group/Mod20_Segment_2/blob/main/North_Data_Finalized_1.csv"), method="auto",...)
